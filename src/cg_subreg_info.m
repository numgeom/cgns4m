...
[io_regname, out_dimension, out_location, out_ptset_type, out_npnts, out_bcname_len, out_gcname_len, ierr] = cgnslib_mex(int32(98), in_fn, in_B, in_Z, in_S, io_regname);
