function ierr = cg_1to1_periodic_write(in_file_number, in_B, in_Z, in_Ii, in_RotationCenter, in_RotationAngle, in_Translation)
% Gateway function for C function cg_1to1_periodic_write.
%
% ierr = cg_1to1_periodic_write(file_number, B, Z, Ii, RotationCenter, RotationAngle, Translation)
%
...
ierr = cgnslib_mex(int32(184), in_file_number, in_B, in_Z, in_Ii, in_RotationCenter, in_RotationAngle, in_Translation);
