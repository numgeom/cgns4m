...
%     donor_range: cell of 64-bit or 32-bit integer (platform dependent), array
%       transform: cell of 32-bit integer (int32), array
%            ierr: 32-bit integer (int32), scalar
%
% The original C function is:
% int cg_1to1_read_global( int fn, int B, char ** connectname, char ** zonename, char ** donorname, int ** range, ptrdiff_t ** donor_range, int ** transform);
%
