function ierr = cg_expfull_write(in_DataType, in_exponents)
% Gateway function for C function cg_expfull_write.
%
% ierr = cg_expfull_write(DataType, exponents)
%
...
switch (datatype)
    ...
    case 7 % CG_ComplexSingle
        in_exponents = complex64(in_exponents);
    case 8 % CG_ComplexDouble
        in_exponents = complex128(in_exponents);
    otherwise
...
ierr = cgnslib_mex(int32(263), in_DataType, in_exponents);
