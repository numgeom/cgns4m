function [io_elements, ierr] = cg_elements_general_read(in_file_number, in_B, in_Z, in_S, in_start, in_end, in_m_type, io_elements)
% Gateway function for C function cg_elements_general_read.
%
% [elements, ierr] = cg_elements_general_read(file_number, B, Z, S, start, end, m_type, elements)
%
...
ierr = cgnslib_mex(int32(113), in_file_number, in_B, in_Z, in_S, in_start, in_end, in_m_type, io_elements);
