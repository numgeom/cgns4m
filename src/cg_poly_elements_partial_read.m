function [io_elements, io_connect_offset, io_parent_data, ierr] = cg_poly_elements_partial_read(in_file_number, in_B, in_Z, in_S, in_start, in_end, io_elements, io_connect_offset, io_parent_data)
% Gateway function for C function cg_poly_elements_partial_read.
%
% [elements, connect_offset, parent_data, ierr] = cg_poly_elements_partial_read(file_number, B, Z, S, start, end, elements, connect_offset, parent_data)
%
