function [out_RotationCenter, out_RotationAngle, out_Translation, ierr] = cg_1to1_periodic_read(in_file_number, in_B, in_Z, in_Ii)
% Gateway function for C function cg_1to1_periodic_read.
%
% [RotationCenter, RotationAngle, Translation, ierr] = cg_1to1_periodic_read(file_number, B, Z, Ii)
%
...
[out_RotationCenter, out_RotationAngle, out_Translation, ierr] = cgnslib_mex(int32(211), in_file_number, in_B, in_Z, in_Ii);
