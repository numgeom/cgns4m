function [io_RotationCenter, io_RotationAngle, io_Translation, ierr] = cg_1to1_periodic_read(in_file_number, in_B, in_Z, in_Ii, io_RotationCenter, io_RotationAngle, io_Translation)
% Gateway function for C function cg_1to1_periodic_read.
%
% [RotationCenter, RotationAngle, Translation, ierr] = cg_1to1_periodic_read(file_number, B, Z, Ii, RotationCenter, RotationAngle, Translation)
%
...
ierr = cgnslib_mex(int32(185), in_file_number, in_B, in_Z, in_Ii, io_RotationCenter, io_RotationAngle, io_Translation);
