function [out_connectname, out_donorname, out_range, out_donor_range, out_transform, ierr] = cg_1to1_read(in_fn, in_B, in_Z, in_I)
% Gateway function for C function cg_1to1_read.
%
% [connectname, donorname, range, donor_range, transform, ierr] = cg_1to1_read(fn, B, Z, I)
%
...
[out_connectname, out_donorname, out_range, out_donor_range, out_transform, ierr] = cgnslib_mex(int32(123), in_fn, in_B, in_Z, in_I);
