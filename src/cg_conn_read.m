function [io_pnts, io_donor_data, ierr] = cg_conn_read(in_file_number, in_B, in_Z, in_Ii, in_donor_datatype, io_pnts, io_donor_data)
% Gateway function for C function cg_conn_read.
%
% [pnts, donor_data, ierr] = cg_conn_read(file_number, B, Z, Ii, donor_datatype, pnts, donor_data)
%
...
ierr = cgnslib_mex(int32(128), in_file_number, in_B, in_Z, in_Ii, in_donor_datatype, io_pnts, io_donor_data);
