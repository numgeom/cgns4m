function [out_RotationCenter, out_RotationAngle, out_Translation, ierr] = cg_conn_periodic_read(in_file_number, in_B, in_Z, in_I)
% Gateway function for C function cg_conn_periodic_read.
%
% [RotationCenter, RotationAngle, Translation, ierr] = cg_conn_periodic_read(file_number, B, Z, I)
%
...
[out_RotationCenter, out_RotationAngle, out_Translation, ierr] = cgnslib_mex(int32(171), in_file_number, in_B, in_Z, in_I);
