...
[io_connectname, io_donorname, out_location, out_type, out_ptset_type, out_npnts, out_donor_zonetype, out_donor_ptset_type, out_donor_datatype, out_ndata_donor, ierr] = cgnslib_mex(int32(116), in_file_number, in_B, in_Z, in_I, io_connectname, io_donorname);
