function [out_connectname, out_location, out_type, out_ptset_type, out_npnts, out_donorname, out_donor_zonetype, out_donor_ptset_type, out_donor_datatype, out_ndata_donor, ierr] = cg_conn_info(in_file_number, in_B, in_Z, in_I)
% Gateway function for C function cg_conn_info.
%
% [connectname, location, type, ptset_type, npnts, donorname, donor_zonetype, donor_ptset_type, donor_datatype, ndata_donor, ierr] = cg_conn_info(file_number, B, Z, I)
%
...
[out_connectname, out_location, out_type, out_ptset_type, out_npnts, out_donorname, out_donor_zonetype, out_donor_ptset_type, out_donor_datatype, out_ndata_donor, ierr] = cgnslib_mex(int32(116), in_file_number, in_B, in_Z, in_I);
