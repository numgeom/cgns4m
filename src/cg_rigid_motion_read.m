function [io_name, out_type, ierr] = cg_rigid_motion_read(in_file_number, in_B, in_Z, in_R, io_name)
% Gateway function for C function cg_rigid_motion_read.
%
% [name, type, ierr] = cg_rigid_motion_read(file_number, B, Z, R, name)
%
...
[io_name, out_type, ierr] = cgnslib_mex(int32(161), in_file_number, in_B, in_Z, in_R, io_name);
