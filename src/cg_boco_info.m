...
[out_bocotype, out_ptset_type, out_npnts, out_NormalListFlag, out_NormalDataType, out_ndataset, ierr] =  cgnslib_mex(int32(103), in_fn, in_B, in_Z, in_BC, io_boconame, io_NormalIndex);
