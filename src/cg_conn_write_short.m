function [out_Ii, ierr] = cg_conn_write_short(in_file_number, in_B, in_Z, in_connectname, in_location, in_type, in_ptset_type, in_npnts, in_pnts, in_donorname)
% Gateway function for C function cg_conn_write_short.
%
% [Ii, ierr] = cg_conn_write_short(file_number, B, Z, connectname, location, type, ptset_type, npnts, pnts, donorname)
%
...
[out_Ii, ierr] = cgnslib_mex(int32(131), in_file_number, in_B, in_Z, in_connectname, in_location, in_type, in_ptset_type, in_npnts, in_pnts, in_donorname);
