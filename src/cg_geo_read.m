...
%        geo_name: character string with default length 32 
%        CAD_name: character string with default length 32 
%
...
[out_geo_file, out_npart, ierr] =  cgnslib_mex(int32(50), in_file_number, in_B, in_F, in_G, io_geo_name, io_CAD_name);
