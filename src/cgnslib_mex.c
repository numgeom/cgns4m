...
/* Gateway function 
 * [out_S, ierr] = cg_section_partial_write(in_file_number, in_B, in_Z, in_SectionName, in_type, in_start, in_end, in_nbndry, in_elements) 
 *
 * The original C interface is 
    ...
    int nrhs, const mxArray *prhs[])
{
    ...
    /******** Invoke computational function ********/
    ierr = cg_section_partial_write(in_file_number, in_B, in_Z, in_SectionName, in_type, in_start, in_end, in_nbndry, in_elements, &out_S);
...
/* Gateway function 
 * ierr = cg_parent_data_partial_write(in_fn, in_B, in_Z, in_S, in_rmin, in_rmax, in_ParentData) 
 *
 * The original C interface is 
    ...
    int nrhs, const mxArray *prhs[])
{
    ...
    if (_n_dims(prhs[4]) > 0)
        mexErrMsgTxt("Error in dimension of argument rmin");
    in_rmin = _get_numeric_scalar_int32(prhs[4]);

    if (_n_dims(prhs[5]) > 0)
        mexErrMsgTxt("Error in dimension of argument rmax");
    in_rmax = _get_numeric_scalar_int32(prhs[5]);
    ...
    int nrhs, const mxArray *prhs[])
{
    ...
    if (_n_dims(prhs[0]) > 0)
        mexErrMsgTxt("Error in dimension of argument BCType");
    in_BCType = _get_numeric_scalar_int32(prhs[0]);

    if (_n_dims(prhs[1]) > 0)
        mexErrMsgTxt("Error in dimension of argument BCDataType");
    in_BCDataType = _get_numeric_scalar_int32(prhs[1]);

    io_name = _mxGetString(prhs[2], NULL);


    /******** Invoke computational function ********/
    ierr = cg_bcdataset_write(io_name, in_BCType, in_BCDataType);


    /******** Process inout argument. ********/
    _mxPutString(io_name, (mxArray*)prhs[2]);
...
/* Gateway function 
 * [out_ModelType, ierr] = cg_model_read(io_ModelLabel) 
 *
 * The original C interface is 
    ...
    int nrhs, const mxArray *prhs[])
{
    ...
    /******** Obtain input arguments ********/
    io_ModelLabel = _mxGetString(prhs[0], NULL);


    /******** Invoke computational function ********/
    ierr = cg_model_read(io_ModelLabel, &out_ModelType);


    /******** Process inout argument. ********/
    _mxPutString(io_ModelLabel, (mxArray*)prhs[0]);
...
/* Gateway function 
 * ierr = cg_delete_node(io_node_name) 
 *
 * The original C interface is 
    ...
    int nrhs, const mxArray *prhs[])
{
    ...
    /******** Obtain input arguments ********/
    io_node_name = _mxGetString(prhs[0], NULL);
    ...
    /******** Process inout argument. ********/
    _mxPutString(io_node_name, (mxArray*)prhs[0]);
    ...
    int nrhs, const mxArray *prhs[])
{
    ...
    static C2mex_func_ptr  fptrs[] = {
        ...
        /* 5 */ cg_configure_MeX,
        /* 6 */ cg_is_cgns_MeX,
        /* 7 */ cg_MassUnitsName_MeX,
        /* 8 */ cg_LengthUnitsName_MeX,
        /* 9 */ cg_TimeUnitsName_MeX,
        /* 10 */ cg_TemperatureUnitsName_MeX,
        /* 11 */ cg_AngleUnitsName_MeX,
        /* 12 */ cg_ElectricCurrentUnitsName_MeX,
        /* 13 */ cg_SubstanceAmountUnitsName_MeX,
        /* 14 */ cg_LuminousIntensityUnitsName_MeX,
        /* 15 */ cg_DataClassName_MeX,
        /* 16 */ cg_GridLocationName_MeX,
        /* 17 */ cg_BCDataTypeName_MeX,
        /* 18 */ cg_GridConnectivityTypeName_MeX,
        /* 19 */ cg_PointSetTypeName_MeX,
        /* 20 */ cg_GoverningEquationsTypeName_MeX,
        /* 21 */ cg_ModelTypeName_MeX,
        /* 22 */ cg_BCTypeName_MeX,
        /* 23 */ cg_DataTypeName_MeX,
        /* 24 */ cg_ElementTypeName_MeX,
        /* 25 */ cg_ZoneTypeName_MeX,
        /* 26 */ cg_RigidGridMotionTypeName_MeX,
        /* 27 */ cg_ArbitraryGridMotionTypeName_MeX,
        /* 28 */ cg_SimulationTypeName_MeX,
        /* 29 */ cg_WallFunctionTypeName_MeX,
        /* 30 */ cg_AreaTypeName_MeX,
        /* 31 */ cg_AverageInterfaceTypeName_MeX,
        /* 32 */ cg_nbases_MeX,
        /* 33 */ cg_base_read_MeX,
        /* 34 */ cg_base_id_MeX,
        /* 35 */ cg_base_write_MeX,
        /* 36 */ cg_nzones_MeX,
        /* 37 */ cg_zone_read_MeX,
        /* 38 */ cg_zone_type_MeX,
        /* 39 */ cg_zone_id_MeX,
        /* 40 */ cg_zone_write_MeX,
        /* 41 */ cg_simulation_type_read_MeX,
        /* 42 */ cg_simulation_type_write_MeX,
        /* 43 */ cg_nfamilies_MeX,
        /* 44 */ cg_family_read_MeX,
        /* 45 */ cg_family_write_MeX,
        /* 46 */ cg_famname_read_MeX,
        /* 47 */ cg_famname_write_MeX,
        /* 48 */ cg_fambc_read_MeX,
        /* 49 */ cg_fambc_write_MeX,
        /* 50 */ cg_geo_read_MeX,
        /* 51 */ cg_geo_write_MeX,
        /* 52 */ cg_part_read_MeX,
        /* 53 */ cg_part_write_MeX,
        /* 54 */ cg_ngrids_MeX,
        /* 55 */ cg_grid_read_MeX,
        /* 56 */ cg_grid_write_MeX,
        /* 57 */ cg_ncoords_MeX,
        /* 58 */ cg_coord_info_MeX,
        /* 59 */ cg_coord_read_MeX,
        /* 60 */ cg_coord_id_MeX,
        /* 61 */ cg_coord_write_MeX,
        /* 62 */ cg_coord_partial_write_MeX,
        /* 63 */ cg_nsections_MeX,
        /* 64 */ cg_section_read_MeX,
        /* 65 */ cg_elements_read_MeX,
        /* 66 */ cg_section_write_MeX,
        /* 67 */ cg_parent_data_write_MeX,
        /* 68 */ cg_npe_MeX,
        /* 69 */ cg_ElementDataSize_MeX,
        /* 70 */ cg_section_partial_write_MeX,
        /* 71 */ cg_parent_data_partial_write_MeX,
        /* 72 */ cg_elements_partial_read_MeX,
        /* 73 */ cg_ElementPartialSize_MeX,
        /* 74 */ cg_nsols_MeX,
        /* 75 */ cg_sol_info_MeX,
        /* 76 */ cg_sol_id_MeX,
        /* 77 */ cg_sol_write_MeX,
        /* 78 */ cg_nfields_MeX,
        /* 79 */ cg_field_info_MeX,
        /* 80 */ cg_field_read_MeX,
        /* 81 */ cg_field_id_MeX,
        /* 82 */ cg_field_write_MeX,
        /* 83 */ cg_field_partial_write_MeX,
        /* 84 */ cg_nholes_MeX,
        /* 85 */ cg_hole_info_MeX,
        /* 86 */ cg_hole_read_MeX,
        /* 87 */ cg_hole_id_MeX,
        /* 88 */ cg_hole_write_MeX,
        /* 89 */ cg_nconns_MeX,
        /* 90 */ cg_conn_info_MeX,
        /* 91 */ cg_conn_read_MeX,
        /* 92 */ cg_conn_id_MeX,
        /* 93 */ cg_conn_write_MeX,
        /* 94 */ cg_conn_write_short_MeX,
        /* 95 */ cg_conn_read_short_MeX,
        /* 96 */ cg_n1to1_MeX,
        /* 97 */ cg_1to1_read_MeX,
        /* 98 */ cg_1to1_id_MeX,
        /* 99 */ cg_1to1_write_MeX,
        /* 100 */ cg_n1to1_global_MeX,
        /* 101 */ cg_1to1_read_global_MeX,
        /* 102 */ cg_nbocos_MeX,
        /* 103 */ cg_boco_info_MeX,
        /* 104 */ cg_boco_read_MeX,
        /* 105 */ cg_boco_id_MeX,
        /* 106 */ cg_boco_write_MeX,
        /* 107 */ cg_boco_normal_write_MeX,
        /* 108 */ cg_dataset_read_MeX,
        /* 109 */ cg_dataset_write_MeX,
        /* 110 */ cg_bcdataset_write_MeX,
        /* 111 */ cg_bcdataset_info_MeX,
        /* 112 */ cg_bcdataset_read_MeX,
        /* 113 */ cg_bcdata_write_MeX,
        /* 114 */ cg_ndiscrete_MeX,
        /* 115 */ cg_discrete_read_MeX,
        /* 116 */ cg_discrete_write_MeX,
        /* 117 */ cg_n_rigid_motions_MeX,
        /* 118 */ cg_rigid_motion_read_MeX,
        /* 119 */ cg_rigid_motion_write_MeX,
        /* 120 */ cg_n_arbitrary_motions_MeX,
        /* 121 */ cg_arbitrary_motion_read_MeX,
        /* 122 */ cg_arbitrary_motion_write_MeX,
        /* 123 */ cg_biter_read_MeX,
        /* 124 */ cg_biter_write_MeX,
        /* 125 */ cg_ziter_read_MeX,
        /* 126 */ cg_ziter_write_MeX,
        /* 127 */ cg_gravity_read_MeX,
        /* 128 */ cg_gravity_write_MeX,
        /* 129 */ cg_axisym_read_MeX,
        /* 130 */ cg_axisym_write_MeX,
        /* 131 */ cg_rotating_read_MeX,
        /* 132 */ cg_rotating_write_MeX,
        /* 133 */ cg_bc_wallfunction_read_MeX,
        /* 134 */ cg_bc_wallfunction_write_MeX,
        /* 135 */ cg_bc_area_read_MeX,
        /* 136 */ cg_bc_area_write_MeX,
        /* 137 */ cg_conn_periodic_read_MeX,
        /* 138 */ cg_conn_periodic_write_MeX,
        /* 139 */ cg_1to1_periodic_write_MeX,
        /* 140 */ cg_1to1_periodic_read_MeX,
        /* 141 */ cg_conn_average_read_MeX,
        /* 142 */ cg_conn_average_write_MeX,
        /* 143 */ cg_1to1_average_write_MeX,
        /* 144 */ cg_1to1_average_read_MeX,
        /* 145 */ cg_goto_MeX,
        /* 146 */ cg_gorel_MeX,
        /* 147 */ cg_gopath_MeX,
        /* 148 */ cg_golist_MeX,
        /* 149 */ cg_where_MeX,
        /* 150 */ cg_convergence_read_MeX,
        /* 151 */ cg_convergence_write_MeX,
        /* 152 */ cg_state_read_MeX,
        /* 153 */ cg_state_write_MeX,
        /* 154 */ cg_equationset_read_MeX,
        /* 155 */ cg_equationset_chemistry_read_MeX,
        /* 156 */ cg_equationset_elecmagn_read_MeX,
        /* 157 */ cg_equationset_write_MeX,
        /* 158 */ cg_governing_read_MeX,
        /* 159 */ cg_governing_write_MeX,
        /* 160 */ cg_diffusion_read_MeX,
        /* 161 */ cg_diffusion_write_MeX,
        /* 162 */ cg_model_read_MeX,
        /* 163 */ cg_model_write_MeX,
        /* 164 */ cg_narrays_MeX,
        /* 165 */ cg_array_info_MeX,
        /* 166 */ cg_array_read_MeX,
        /* 167 */ cg_array_read_as_MeX,
        /* 168 */ cg_array_write_MeX,
        /* 169 */ cg_nuser_data_MeX,
        /* 170 */ cg_user_data_read_MeX,
        /* 171 */ cg_user_data_write_MeX,
        /* 172 */ cg_nintegrals_MeX,
        /* 173 */ cg_integral_read_MeX,
        /* 174 */ cg_integral_write_MeX,
        /* 175 */ cg_rind_read_MeX,
        /* 176 */ cg_rind_write_MeX,
        /* 177 */ cg_ndescriptors_MeX,
        /* 178 */ cg_descriptor_read_MeX,
        /* 179 */ cg_descriptor_write_MeX,
        /* 180 */ cg_nunits_MeX,
        /* 181 */ cg_units_read_MeX,
        /* 182 */ cg_units_write_MeX,
        /* 183 */ cg_unitsfull_read_MeX,
        /* 184 */ cg_unitsfull_write_MeX,
        /* 185 */ cg_exponents_info_MeX,
        /* 186 */ cg_nexponents_MeX,
        /* 187 */ cg_exponents_read_MeX,
        /* 188 */ cg_exponents_write_MeX,
        /* 189 */ cg_expfull_read_MeX,
        /* 190 */ cg_expfull_write_MeX,
        /* 191 */ cg_conversion_info_MeX,
        /* 192 */ cg_conversion_read_MeX,
        /* 193 */ cg_conversion_write_MeX,
        /* 194 */ cg_dataclass_read_MeX,
        /* 195 */ cg_dataclass_write_MeX,
        /* 196 */ cg_gridlocation_read_MeX,
        /* 197 */ cg_gridlocation_write_MeX,
        /* 198 */ cg_ordinal_read_MeX,
        /* 199 */ cg_ordinal_write_MeX,
        /* 200 */ cg_ptset_info_MeX,
        /* 201 */ cg_ptset_write_MeX,
        /* 202 */ cg_ptset_read_MeX,
        /* 203 */ cg_is_link_MeX,
        /* 204 */ cg_link_read_MeX,
        /* 205 */ cg_link_write_MeX,
        /* 206 */ cg_delete_node_MeX,
        /* 207 */ cg_get_error_MeX,
        /* 208 */ cg_error_exit_MeX,
        /* 209 */ cg_error_print_MeX
    };
