...
#define CGNS_VERSION 2530
#define CGNS_DOTVERS 2.53
...
/*%output range(3), donor_range(3), transform(3) */
/*%url http://www.grc.nasa.gov/WWW/cgns/midlevel/connectivity.html */
...
CGNSDLL int cg_model_read(char *ModelLabel, ModelType_t *ModelType);
/*%output ModelType */
/*%url http://www.grc.nasa.gov/WWW/cgns/midlevel/equation.html */
